...
def test_extreme_iana_time_uses_recurring_future_zone_mapping() -> None:
    location = ZoneInfo("America/New_York")
    civil = _civil.civil_from_unix(253_402_300_800, 0, location)

    assert civil.zone_name in {"EST", "EDT"}
    assert civil.offset_seconds in {-18_000, -14_400}
